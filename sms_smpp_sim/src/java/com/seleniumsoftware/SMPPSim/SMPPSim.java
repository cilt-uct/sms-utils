 ...
 * http://www.seleniumsoftware.com
 * $Header: /var/cvsroot/SMPPSim2/src/java/com/seleniumsoftware/SMPPSim/SMPPSim.java,v 1.13 2008/04/13 14:48:29 martin Exp $
 ****************************************************************************
...
public class SMPPSim {
	...
	private static void initialise(Properties props) throws IOException {
		...
		systemid = props.getProperty("SYSTEM_ID");
