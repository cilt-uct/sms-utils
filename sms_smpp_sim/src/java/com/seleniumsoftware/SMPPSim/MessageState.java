 ...
 * $Header: /var/cvsroot/SMPPSim2/src/java/com/seleniumsoftware/SMPPSim/MessageState.java,v 1.4 2007/12/06 16:21:36 martin Exp $
 ****************************************************************************/
		...
		try {
			if (!pdu.getValidity_period().equals(""))
				validity_period = new SmppTime(pdu.getValidity_period());
					...
					logger.warning("Validity period is not set: defaulting to 5 minutes from now");
			...
			logger.warning("Could not parse validity perdiod : using default of 5 minutes");
