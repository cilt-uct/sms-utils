 ...
 * $Header: /var/cvsroot/SMPPSim2/src/java/com/seleniumsoftware/SMPPSim/pdu/DeliveryReceipt.java,v 1.10 2007/12/06 16:21:37 martin Exp $
 ****************************************************************************/
...
public class DeliveryReceipt extends DeliverSM {
	...
	public DeliveryReceipt(SubmitSM msg) {
		super(msg);
		setEsm_class(4);
		setValidity_period("");
