 ...
 * $Header: /var/cvsroot/SMPPSim2/src/java/com/seleniumsoftware/SMPPSim/Smsc.java,v 1.11 2008/03/16 16:58:55 martin Exp $
 ****************************************************************************/
...
public class Smsc {
	...
	public void start() throws Exception {
		...
		iq = new InboundQueue(inbound_queue_capacity);
	...
	public void outbind() {
		try {
			...
			Outbind outbind = new Outbind(SMPPSim.getSystemid(),SMPPSim.getEsme_password());
	...
	public void prepareDeliveryReceipt(SubmitSM smppmsg, String messageID,
		...
		DeliveryReceipt receipt = new DeliveryReceipt(smppmsg);
