 ...
 * $Header: /var/cvsroot/SMPPSim2/src/java/com/seleniumsoftware/SMPPSim/StandardProtocolHandler.java,v 1.7 2008/03/16 16:58:55 martin Exp $
 ****************************************************************************/
...
public class StandardProtocolHandler {
	...
	void getBindTRNResponse(byte[] message, int len) throws Exception {
		...
		if (smppmsg.getSystem_id().equals(SMPPSim.getSystemid())
				&& smppmsg.getPassword().equals(SMPPSim.getPassword())) {
